              ...
              >
                <Dialog.Panel className="pointer-events-auto w-screen max-w-md">
                  <div className="flex h-full flex-col overflow-y-scroll bg-white py-6 shadow-xl">
                    <div className="px-4 sm:px-6 pb-5 border-b-2">
                    ...
                    <div className="relative mt-6 flex-1 ">
                      <div className="border-b-2 px-4 sm:px-6 pb-4">
                        <p className="text-lg font-bold text-black">
                          Deepak Arora
                        </p>
                        <p className="text-gray-500">Keenagile@gmail.com</p>
                        <div className="mt-2">
                          <button
                            type="button"
                            className="inline-flex mr-2 items-center gap-x-2 rounded-md px-3.5 py-2 text-xs font-semibold shadow-sm sideBtn"
                          >
                            Sign Out
                          </button>
                          <button
                            type="button"
                            className="inline-flex items-center gap-x-2 rounded-md px-3.5 py-2 text-xs font-semibold shadow-sm sideBtn"
                          >
                            User Profile
                          </button>
                        </div>
                      ...
                      <div>
                        <a href="#" className="menu-link">
                          <span className="svg-icon svg-icon-primary svg-icon-2hx me-2">
                            <svg
                              width="24"
                              height="24"
                              viewBox="0 0 24 24"
