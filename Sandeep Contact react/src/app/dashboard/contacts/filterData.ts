...
const equalnum = (data: any[], item: any) => {
  if (!item.value) {
    return true;
  }
  return (
...
const notequalnum =(data: any[], item: any) => {
  if (!item.value) {
    return true;
  }
  return (
...
export const filterItem = (data: any[], filter: any) => {
  switch (filter.operator) {
    ...
    case "==":
        return equalnum(data, filter);
    case "!=":
        return notequalnum(data, filter);
    default:
